function saveSettingsToLocalStorage() {
	...
	const hiddenFields = document.querySelectorAll("textarea:not(.avoid)");
	...
	hiddenFields.forEach((hiddenfield) => {
		...
		settings[hiddenfield.name] = hiddenfieldvalue.trim();
	});
...
function generateUrl() {
	...
	hiddenFields.forEach((hiddenfield) => {
		params.set(hiddenfield.name, hiddenfield.value);
	});
